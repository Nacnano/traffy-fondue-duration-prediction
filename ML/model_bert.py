...
test_dataset = TraffyDataset(test_df, tokenizer, MAX_LEN)
...
test_loss, test_mae, test_rmse = eval_model(model, test_loader, criterion, DEVICE, duration_scaler)
print(f'Test Loss: {test_loss:.4f}, Test MAE: {test_mae:.2f} days, Test RMSE: {test_rmse:.2f} days')
...
plt.title('Actual vs. Predicted Duration (Days) on Test Set')
